...
WebUI.click(findTestObject('Object Repository/Page_AI Participants/a_Student Branch'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Nhp mn tr tu nhn to Personal profile S_802039/h2_Student Branch'), 
    'Student Branch')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Nhp mn tr tu nhn to Personal profile S_802039/a_s9example.com'), 
    's9@example.com')
