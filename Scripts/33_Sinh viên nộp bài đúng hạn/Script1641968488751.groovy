...
WebUI.click(findTestObject('Object Repository/Page_Course Nhp mn tr tu nhn to/span_Assignment 2'))
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_AI Assignment 2/td_Submitted for grading'), 'Submitted for grading')

WebUI.verifyElementText(findTestObject('Object Repository/Page_AI Assignment 2/p_Noi dung bai nop'), 'Noi dung bai nop')
