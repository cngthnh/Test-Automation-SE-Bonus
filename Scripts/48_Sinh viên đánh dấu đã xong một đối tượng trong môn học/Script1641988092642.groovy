...
WebUI.click(findTestObject('Object Repository/Page_Course Nhp mn tr tu nhn to/button_Mark as done'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Course Nhp mn tr tu nhn to/button_Done'), 'Done')
