...
WebUI.click(findTestObject('Object Repository/Page_KHTN Administration Users Accounts Add_aad8ed/div_First name'))
...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_KHTN Administration Users Accounts Add_aad8ed/div_Passwords must be at least 8 characters long'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_KHTN Administration Users Accounts Add_aad8ed/div_Passwords must have at least 1 digit(s)'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_KHTN Administration Users Accounts Add_aad8ed/div_Passwords must have at least 1 digit(s)'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_KHTN Administration Users Accounts Add_aad8ed/div_Passwords must have at least 1 upper ca_8e926f'))
