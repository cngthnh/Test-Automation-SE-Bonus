...
WebUI.click(findTestObject('Object Repository/Page_AI Participants/a_Student Tremblay'))

WebUI.click(findTestObject('Object Repository/Page_Nhp mn tr tu nhn to Personal profile S_718f45/span_Add to contacts'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Nhp mn tr tu nhn to Personal profile S_718f45/span_Remove from contacts'), 
