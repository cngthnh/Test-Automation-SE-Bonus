...
WebUI.click(findTestObject('Object Repository/Page_Forum 1/i_Subscribe to this discussion_icon fa fa-e_f628f6'))

WebUI.click(findTestObject('Object Repository/Page_Forum 1/span_Lock this discussion'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Forum 1/div_The lock option has been updated'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Forum 1/span_Locked'), 'Locked')
