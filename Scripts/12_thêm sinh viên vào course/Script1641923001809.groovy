...
WebUI.click(findTestObject('Object Repository/Page_HCMUS/a_Nhp mn tr tu nhn to_1'))
...
WebUI.setText(findTestObject('Object Repository/Page_AI Participants/input_No selection_form_autocomplete_input-_6680aa'), 
    'Student')
