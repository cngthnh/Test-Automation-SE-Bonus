...
WebUI.click(findTestObject('Object Repository/Page_Course Nhp mn tr tu nhn to/div_Folder'))

WebUI.setText(findTestObject('Object Repository/Page_Editing Folder/input_Name_name'), 'Documents')

WebUI.click(findTestObject('Object Repository/Page_Editing Folder/input_Upon activity completion_submitbutton'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_AI Documents/h2_Documents'), 'Documents')
