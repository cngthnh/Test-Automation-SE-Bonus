...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_KHTN Add a new course/div_- Missing full name'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_KHTN Add a new course/div_- Missing short name'))
