...
WebUI.click(findTestObject('Object Repository/Page_Course Nhp mn tr tu nhn to/button_Add an activity or resource'))

WebUI.click(findTestObject('Object Repository/Page_Course Nhp mn tr tu nhn to/div_Information about the Folder activity_o_1fd216'))

WebUI.setText(findTestObject('Object Repository/Page_Editing Forum/input_Forum name_name'), 'Forum 1')

WebUI.click(findTestObject('Object Repository/Page_Editing Forum/input_Upon activity completion_submitbutton'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Forum 1/h2_Forum 1'), 'Forum 1')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Forum 1/div_(There are no discussion topics yet in _507a86'), 
