...
WebUI.click(findTestObject('Object Repository/Page_Forum 1/a_Add a new discussion topic'))

WebUI.setText(findTestObject('Object Repository/Page_Forum 1/div_Xin chao cac ban'), '<p dir="ltr" style="text-align: left;">Xin chao cac ban</p>')

WebUI.click(findTestObject('Object Repository/Page_Forum 1/input_Message_submitbutton'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Forum 1/div_- Required'), '- Required')
