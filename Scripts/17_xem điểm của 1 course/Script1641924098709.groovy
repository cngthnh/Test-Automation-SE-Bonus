...
WebUI.click(findTestObject('Object Repository/Page_Course Nhp mn tr tu nhn to/span_Grades'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Grades View/span_Course total'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Grades View/th_Overall average'))
