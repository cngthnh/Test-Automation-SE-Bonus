...
WebUI.click(findTestObject('Object Repository/Page_KHTN Administration Search/a_Add a category'))

WebUI.setText(findTestObject('Object Repository/Page_KHTN Add new category/input_Category name_name'), 'IT')

WebUI.click(findTestObject('Object Repository/Page_KHTN Add new category/input_Description_submitbutton'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Course and category management/a_IT'), 'IT')
