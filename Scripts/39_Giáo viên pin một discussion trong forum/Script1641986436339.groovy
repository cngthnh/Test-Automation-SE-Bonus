...
WebUI.click(findTestObject('Object Repository/Page_Forum 1/span_Pin this discussion'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Forum 1/i_Actions_icon fa fa-map-pin fa-fw'))
