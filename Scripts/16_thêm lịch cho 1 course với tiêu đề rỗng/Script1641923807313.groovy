...
WebUI.click(findTestObject('Object Repository/Page_AI Calendar Detailed month view January 2022/div_No events, Saturday, 22 January        _e72aa9'))

WebUI.click(findTestObject('Object Repository/Page_AI Calendar Detailed month view January 2022/button_Save'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_AI Calendar Detailed month view January 2022/div_- Required'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_AI Calendar Detailed month view January 2022/input_Event title_name'))
