...
WebUI.click(findTestObject('Object Repository/Page_AI Quiz 2/a_Quiz 2_action-menu-toggle-3'))

WebUI.click(findTestObject('Object Repository/Page_AI Quiz 2/a_Grades'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Quiz 2/td_Overall average'), 'Overall average')
