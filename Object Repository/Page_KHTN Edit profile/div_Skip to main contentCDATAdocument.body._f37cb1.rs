...
<WebElementEntity>
   ...
   <name>div_Skip to main contentCDATAdocument.body._f37cb1</name>
   <tag></tag>
   <elementGuidId>b51a3224-0c63-4117-8194-3688df6ea425</elementGuidId>
   <selectorCollection>
      <entry>
         <key>XPATH</key>
...
&lt;div>&lt;object type='text/html' data='http://localhost/repository/draftfiles_manager.php?action=browse&amp;amp;env=editor&amp;amp;itemid=429625670&amp;amp;subdirs=0&amp;amp;maxbytes=0&amp;amp;areamaxbytes=-1&amp;amp;maxfiles=-1&amp;amp;ctx_id=25&amp;amp;course=1&amp;amp;sesskey=PXZMFgkTTv' height='160' width='600' style='border:1px solid #000'>&lt;/object>&lt;/div>
        ...
        Maximum file size: 40MB, maximum number of files: 1
...
&lt;div>&lt;object type='text/html' data='http://localhost/repository/draftfiles_manager.php?env=filemanager&amp;amp;action=browse&amp;amp;itemid=229577741&amp;amp;subdirs=0&amp;amp;maxbytes=41943040&amp;amp;areamaxbytes=-1&amp;amp;maxfiles=1&amp;amp;ctx_id=25&amp;amp;course=1&amp;amp;sesskey=PXZMFgkTTv' height='160' width='600' style='border:1px solid #000'>&lt;/object>&lt;/div>Accepted file types:
...
var skipClientValidation = false;
            ...
            You are logged in as Student Waldrop (Log out)
...
//&lt;![CDATA[
var require = {
    baseUrl : 'http://localhost/lib/requirejs.php/1641909006/',
    ...
    paths: {
        jquery: 'http://localhost/lib/javascript.php/1641909006/lib/jquery/jquery-3.5.1.min',
        jqueryui: 'http://localhost/lib/javascript.php/1641909006/lib/jquery/ui-1.12.1/jquery-ui.min',
        jqueryprivate: 'http://localhost/lib/javascript.php/1641909006/lib/requirejs/jquery-private'
    },
...
function(
    ...
    var toggle = $('#message-drawer-toggle-61dec225f1eb861dec225e466c3');
    Popover.init(toggle);
});
;
...
require(['jquery', 'core_message/message_drawer'], function($, MessageDrawer) {
    var root = $('#message-drawer-61dec2260243261dec225e466c12');
    MessageDrawer.init(root, '61dec2260243261dec225e466c12', false);
});
;
...
require(['theme_boost/form-display-errors'], function(module) {
    module.enhance(&quot;id_maildisplay&quot;);
});
;

require(['theme_boost/form-display-errors'], function(module) {
    module.enhance(&quot;id_moodlenetprofile&quot;);
});
;
...
require(['theme_boost/form-display-errors'], function(module) {
    module.enhance(&quot;id_description_editor&quot;);
});
;

require(['theme_boost/form-display-errors'], function(module) {
    module.enhance(&quot;id_currentpicture&quot;);
});
;
...
require(['theme_boost/form-display-errors'], function(module) {
    module.enhance(&quot;id_imagefile&quot;);
});
;

(function() {
    var label = document.getElementById('id_imagefile_label');
    if (label) {
        label.style.cursor = 'default';
        label.addEventListener('click', function() {
            document.querySelectorAll('#id_imagefile_fieldset div.fp-toolbar a')[0].focus();
        });
    }
})();
;
...
require(['theme_boost/form-display-errors'], function(module) {
    module.enhance(&quot;id_imagealt&quot;);
});
;

require(['theme_boost/form-display-errors'], function(module) {
    module.enhance(&quot;id_firstnamephonetic&quot;);
});
;

require(['theme_boost/form-display-errors'], function(module) {
    module.enhance(&quot;id_lastnamephonetic&quot;);
});
;
...
require(['theme_boost/form-display-errors'], function(module) {
    module.enhance(&quot;id_alternatename&quot;);
});
;

require(['theme_boost/form-display-errors'], function(module) {
    module.enhance(&quot;id_interests&quot;);
});
;
...
require([&quot;core/event&quot;, &quot;jquery&quot;], function(Event, $) {
    ...
    function validate_user_edit_form_firstname(element, escapedName) {
  ...
  if (value == '' &amp;&amp; !errFlag['firstname']) {
    ...
    document.getElementById('id_firstname').addEventListener('blur', function(ev) {
        validate_user_edit_form_firstname(ev.target, 'firstname')
    });
    document.getElementById('id_firstname').addEventListener('change', function(ev) {
        validate_user_edit_form_firstname(ev.target, 'firstname')
    });

    function validate_user_edit_form_lastname(element, escapedName) {
      if (undefined == element) {
         //required element was not found, then let form be submitted without client side validation
         return true;
      }
  ...
  if (value == '' &amp;&amp; !errFlag['lastname']) {
    ...
    document.getElementById('id_lastname').addEventListener('blur', function(ev) {
        validate_user_edit_form_lastname(ev.target, 'lastname')
    });
    document.getElementById('id_lastname').addEventListener('change', function(ev) {
        validate_user_edit_form_lastname(ev.target, 'lastname')
    });

    function validate_user_edit_form_email(element, escapedName) {
      if (undefined == element) {
         //required element was not found, then let form be submitted without client side validation
         return true;
      }
  ...
  if (value == '' &amp;&amp; !errFlag['email']) {
    ...
    document.getElementById('id_email').addEventListener('blur', function(ev) {
        validate_user_edit_form_email(ev.target, 'email')
    });
    ...
    function validate_user_edit_form() {
      if (skipClientValidation) {
         return true;
      }
      var ret = true;

      var frm = document.getElementById('mform1_SS2CIjBfVYTQTnl')
      var first_focus = false;
    
      ret = validate_user_edit_form_firstname(frm.elements['firstname'], 'firstname') &amp;&amp; ret;
      if (!ret &amp;&amp; !first_focus) {
        first_focus = true;
        Y.use('moodle-core-event', function() {
            Y.Global.fire(M.core.globalEvents.FORM_ERROR, {formid: 'mform1_SS2CIjBfVYTQTnl',
                                                           elementid: 'id_error_firstname'});
            document.getElementById('id_error_firstname').focus();
        });
      }

      ret = validate_user_edit_form_lastname(frm.elements['lastname'], 'lastname') &amp;&amp; ret;
      if (!ret &amp;&amp; !first_focus) {
        first_focus = true;
        Y.use('moodle-core-event', function() {
            Y.Global.fire(M.core.globalEvents.FORM_ERROR, {formid: 'mform1_SS2CIjBfVYTQTnl',
      ...
      ret = validate_user_edit_form_email(frm.elements['email'], 'email') &amp;&amp; ret;
      if (!ret &amp;&amp; !first_focus) {
        first_focus = true;
        Y.use('moodle-core-event', function() {
            Y.Global.fire(M.core.globalEvents.FORM_ERROR, {formid: 'mform1_SS2CIjBfVYTQTnl',
...
;
    ...
    var form = $(document.getElementById('mform1_SS2CIjBfVYTQTnl')).closest('form');
    form.on(M.core.event.FORM_SUBMIT_AJAX, function() {
        try {
            var myValidator = validate_user_edit_form;
        } catch(e) {
            return true;
        }
        if (myValidator) {
    ...
    document.getElementById('mform1_SS2CIjBfVYTQTnl').addEventListener('submit', function(ev) {
        try {
            var myValidator = validate_user_edit_form;
        } catch(e) {
            return true;
...
//&lt;![CDATA[
M.yui.add_module({&quot;core_filepicker&quot;:{&quot;name&quot;:&quot;core_filepicker&quot;,&quot;fullpath&quot;:&quot;http:\/\/localhost\/lib\/javascript.php\/1641909006\/repository\/filepicker.js&quot;,&quot;requires&quot;:[&quot;base&quot;,&quot;node&quot;,&quot;node-event-simulate&quot;,&quot;json&quot;,&quot;async-queue&quot;,&quot;io-base&quot;,&quot;io-upload-iframe&quot;,&quot;io-form&quot;,&quot;yui2-treeview&quot;,&quot;panel&quot;,&quot;cookie&quot;,&quot;datatable&quot;,&quot;datatable-sort&quot;,&quot;resize-plugin&quot;,&quot;dd-plugin&quot;,&quot;escape&quot;,&quot;moodle-core_filepicker&quot;,&quot;moodle-core-notification-dialogue&quot;]},&quot;core_dndupload&quot;:{&quot;name&quot;:&quot;core_dndupload&quot;,&quot;fullpath&quot;:&quot;http:\/\/localhost\/lib\/javascript.php\/1641909006\/lib\/form\/dndupload.js&quot;,&quot;requires&quot;:[&quot;node&quot;,&quot;event&quot;,&quot;json&quot;,&quot;core_filepicker&quot;]},&quot;form_filemanager&quot;:{&quot;name&quot;:&quot;form_filemanager&quot;,&quot;fullpath&quot;:&quot;http:\/\/localhost\/lib\/javascript.php\/1641909006\/lib\/form\/filemanager.js&quot;,&quot;requires&quot;:[&quot;moodle-core-notification-dialogue&quot;,&quot;core_filepicker&quot;,&quot;base&quot;,&quot;io-base&quot;,&quot;node&quot;,&quot;json&quot;,&quot;core_dndupload&quot;,&quot;panel&quot;,&quot;resize-plugin&quot;,&quot;dd-plugin&quot;]}});
...
//]]>
   ...
   <webElementXpaths>
      ...
      <type>Main</type>
      <value>//body[@id='page-user-edit']/div[3]</value>
   </webElementXpaths>
   <webElementXpaths>
      <isSelected>false</isSelected>
      <matchCondition>equals</matchCondition>
